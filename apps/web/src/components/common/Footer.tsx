...
import { FooterContainer, FooterStyled } from './styles/footer';
      ...
      <FooterStyled>
        <FooterContainer>
          <Box textAlign="center" mb={5}>
            <Image src="/images/fooretlogo.png" width={150} height={40} alt="TeacherFox logo" />
            <Typography variant="body1">Η Νο1 Πλατφόρμα στην Κύπρο για ιδιαίτερα μαθήματα.</Typography>
          </Box>
          <Box mb={3}>
            <Grid container>
